...
movies_dict = pickle.load(open(r'C:\Users\simpl\Downloads\Movie-Recommender-System\movie_dict.pkl', 'rb'))
movies = pd.DataFrame(movies_dict)

similarity = pickle.load(open(r'C:\Users\simpl\Downloads\Movie-Recommender-System\similarity.pkl', 'rb'))
